...
# DEFAULT_DATASET_DIR = os.path.join(os.path.dirname(__file__), 'data/random_ID_v2')
DEFAULT_DATASET_DIR = "models/random_ID_v2"
...
DEFAULT_CONFIG = {
    ...
    'splits': {
        'train': {
            'size': 240719,
            'pattern': 'random_ID_v2.train'
        },
        'test': {
            'size': 13135,
            'pattern': 'random_ID_v2.test'
        },
        'validation': {
            'size': 13135,
            'pattern': 'random_ID_v2.valid'
        }
    },
    'charset_filename': 'charset_size=206.txt',
    'image_shape': (64, 320, 3),
    'num_of_views': 1,
